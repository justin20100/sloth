...
class WeekReportHomeBloc extends StatelessWidget {
  const WeekReportHomeBloc({Key? key, required this.text, required this.buttonText , required this.route}) : super(key: key);
  final String text;
