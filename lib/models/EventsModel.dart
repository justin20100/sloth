...
class EventsModel {
  ...
  final CollectionReference wReportsRef = FirebaseFirestore.instance.collection('events/WHYbK3b8jyIaKk2IXnwg/wreports');
  final CollectionReference analisisRef = FirebaseFirestore.instance.collection('events/WHYbK3b8jyIaKk2IXnwg/analisis');

  Future<void> createDReport(DateTime date, num anxiety, num cognitiveevaluation, num euphoria, num mood, String moreinfos,
      num motivation, num physiqueevaluation, DateTime sleep,
      num sleepevaluation, num state, num stress, DateTime wakeup, String user_id) {
    return dReportsRef
        .add({
          'date': date,
          'results': {
